...
#
# RLP Template Version 1.4.0 => 1.4.1
#
# Execute in web2py folder after code upgrade like:
# python web2py.py -S eden -M -R applications/eden/modules/templates/RLP/upgrade/1.4.0-1.4.1.py
#
import sys
...
if not failed:
    ...
    def cms_post_duplicate(item):
        ...
        if name in ("SelfRegistrationIntro", "HoursMatrixIntro"):
